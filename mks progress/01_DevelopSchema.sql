...
-- Get the your current system's directory where you can place csv files to upload through queries
SHOW VARIABLES LIKE 'secure_file_priv';
-- Refer the displayed directory path, and place all csv files inside the folder
-- Also, Do copy field (unquoted), to copy the directory path from the query response
